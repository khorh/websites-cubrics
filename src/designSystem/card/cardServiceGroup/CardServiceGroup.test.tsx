...
describe("card service group", () => {
  test("should render the card service group", () => {
    ...
    const cardServiceGroupElement = screen.getByLabelText("services-content");
    expect(cardServiceGroupElement.tagName).toBe("ARTICLE");
    expect(cardServiceGroupElement).toHaveClass("container", { exact: true });
